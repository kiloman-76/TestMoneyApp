                ...
                <div class="col-md-6">
                    <p>
                        <span class="sub-header ">
                            <?= Html::encode("Ваш Баланс: {$balance} руб.") ?><br>
                        </span>

                        <span class="sub-header">
                            <?= Html::encode(" Всего отправлено денег: {$sended_money} руб.") ?><br>
                        </span>

                        <span class="sub-header">
                             <?= Html::encode(" Всего получено денег: {$taked_money} руб.") ?><br>
                        </span>
                    </p>
                </div>
                <div class="col-md-6">
                    ...
                    <a class="btn btn-index btn-md btn-success" href=<?echo Url::to(['/site/operations']);?>>Посмотреть все операции</a>
                    <a class="btn btn-index btn-md btn-success" href=<?echo Url::to(['/site/translate-money']);?>>Сделать новый перевод </a>
                </div>
            </div>
